...
##########################################
###################Mgetty login config###########################################
# after login ok, the pppd will be started by this config
#sudo mv /etc/mgetty/login.config /etc/mgetty/login.config.old
sudo bash -c 'cat > /etc/mgetty/login.config' << EOF
# login.config
#
